    ...
    <div className="relative min-h-screen flex flex-col font-sans items-center justify-center overflow-hidden">
      ...
      <div className="space-y-8 md:space-y-12 text-center z-10 max-w-2xl px-4 mx-auto">
        ...
        <Link href="/onboarding">
          <Button
            size="lg"
            className="mt-4 md:mt-6 w-full md:w-auto px-4 md:px-6 lg:px-10 py-4 md:py-6 lg:py-8 text-base sm:text-lg md:text-xl font-bold text-green-600 hover:text-green-600 bg-white hover:bg-gray-100 rounded-xl shadow-lg transition-all duration-200 transform hover:scale-[1.02] md:hover:scale-105">
