      ...
      <div className="z-10 max-w-3xl px-4 mx-auto">
        <div className="space-y-8 text-center">
          ...
          <div className="flex justify-center gap-20 md:gap-32 mt-8">
            <div
              onClick={() => canSelect && handleChoice(problem.correctImagePath)}
              ...
              <div className="relative w-40 h-40 md:w-48 md:h-48 rounded-xl overflow-hidden hover:scale-110 transition-transform">
                <Image src={problem.correctImagePath} alt="Correct Image" fill className="object-contain" priority />
              </div>
            </div>
            <div
              onClick={() => canSelect && handleChoice(problem.wrongImagePath)}
              className={!canSelect ? 'cursor-default' : 'cursor-pointer'}>
              <div className="relative w-40 h-40 md:w-48 md:h-48 rounded-xl overflow-hidden hover:scale-110 transition-transform">
                <Image src={problem.wrongImagePath} alt="Wrong Image" fill className="object-contain" priority />
              </div>
            </div>
          </div>
