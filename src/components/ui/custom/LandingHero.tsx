...
export default function LandingHero() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-white relative p-8 md:p-16">
      {/* Background dot pattern */}
      <div className="absolute inset-0">
        <DotPattern className="text-green-200 opacity-48" />
      </div>

      {/* Hero Card */}
      <div className="w-full max-w-6xl flex flex-col md:flex-row shadow-xl rounded-3xl relative z-10 overflow-hidden bg-gradient-to-br from-green-400 to-green-500">
  ...
  return (
    <svg
      ...
      <pattern
        ...
        <circle cx="8" cy="8" r="3" className="fill-current" />
      </pattern>
